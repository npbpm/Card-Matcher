...
//        Mat mask = new Mat(l.size(), 1, 0);
//        dm.match(desc1, desc2, goodMatches);
//
//        // Compute the matching rate
//        rate = 100.0 * Core.countNonZero(mask) / l.size();
//
//        Mat OutImage = new Mat();
//        Features2d.drawMatches(i1, kp1, i2, kp2, goodMatches, OutImage);
//
//        return OutImage;
//    }
//}
